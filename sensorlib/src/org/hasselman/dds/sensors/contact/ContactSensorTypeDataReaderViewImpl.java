...
public class ContactSensorTypeDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ContactSensorTypeDataReaderView
{
    private long copyCache;
    private ContactSensorTypeTypeSupport typeSupport;

    public ContactSensorTypeDataReaderViewImpl(org.hasselman.dds.sensors.contact.ContactSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
