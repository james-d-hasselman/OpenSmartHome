...
public class ContactSensorTypeDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ContactSensorTypeDataWriter
{
    private long copyCache;
    private ContactSensorTypeTypeSupport typeSupport;

    public ContactSensorTypeDataWriterImpl(org.hasselman.dds.sensors.contact.ContactSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.hasselman.dds.sensors.contact.ContactSensorType instance_data)
    {
        long uWriter = 0;
