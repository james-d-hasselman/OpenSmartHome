...
public class TemperatureSensorTypeDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TemperatureSensorTypeDataWriter
{
    private long copyCache;
    private TemperatureSensorTypeTypeSupport typeSupport;

    public TemperatureSensorTypeDataWriterImpl(org.hasselman.dds.sensors.temperature.TemperatureSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
