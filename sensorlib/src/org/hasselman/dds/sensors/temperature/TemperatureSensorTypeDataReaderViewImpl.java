...
public class TemperatureSensorTypeDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements TemperatureSensorTypeDataReaderView
{
    private long copyCache;
    private TemperatureSensorTypeTypeSupport typeSupport;

    public TemperatureSensorTypeDataReaderViewImpl(org.hasselman.dds.sensors.temperature.TemperatureSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
